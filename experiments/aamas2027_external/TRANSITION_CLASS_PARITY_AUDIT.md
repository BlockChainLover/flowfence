...
TRANSITION_CLASSES_TOTAL: 22
TRANSITION_CLASSES_VERIFIED: 22
Paired environment/class fixtures: 58.
...
agent_model_invocation | agent_result_to_planner | agent_send | coding_nested_review | coding_workspace_read_after_write | database_sql_error | final_serialization | model_error_retry | planner_assignment | planner_next_step | planner_progress_update | research_network_tools | session_initiation | session_reply_receive | shared_state_read | shared_state_write | task_initialization | termination | termination_budget | tool_error | tool_invocation | tool_result
