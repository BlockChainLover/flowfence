...
- Can support a small-smoke claim that FlowFence-Lite was clean across all 6 FlowFence runs in the clean post-fix MiniMax smoke.
- Can support a small-smoke claim that prompt-filter is vulnerable to indirect workspace poisoning in this MiniMax smoke.
- Cannot support broad real-model robustness.
- Cannot support non-MiniMax generalization.
