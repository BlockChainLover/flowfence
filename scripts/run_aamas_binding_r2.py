#!/usr/bin/env python3
"""Run post-observation PAPC-R2 with fixed quarantine semantics and strict pilot gate."""
...
from src.experiments.aamas_binding_r2 import R2BindingEpisode as BindingEpisode, load_config, check_pilot
...
def run(config,tasks,profile,hashes,output,private_output=None,dry_run=False,source_sha=None,provider_settings=None,pilot=None):
    if not dry_run and config["phase"] == "formal":
        pc,_,_,_=load_config(Path("configs/experiment/aamas2027/r2_pilot.json"))
